...
Proof.
   intros x y.
   unfold eqb_string.
   destruct (string_dec x y) as [e|Hs].
...
Proof.
  intros A m x1 x2 v.
  intros N. unfold t_update.
  apply false_eqb_string in N. rewrite N. reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  intros y. destruct (eqb_string x y).
  - reflexivity.
  - reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  - destruct (eqb_stringP x2 x) as [H2 | H2].
    + rewrite H1 in N. rewrite H2 in N. destruct N. reflexivity.
    + reflexivity.
  - destruct (eqb_stringP x2 x) as [H2 | H2].
    + reflexivity.
    + reflexivity.
